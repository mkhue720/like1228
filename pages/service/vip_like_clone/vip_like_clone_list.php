            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="dataTable table table-bordered table-hover text-center">
                        ...
                        <tbody>
                            <?php 
                            $result = mysqli_query($conn,"SELECT * FROM table_vip_like WHERE vip_like_username = '$user_username' AND vip_like_service = 'vip-like-clone-facebook' ORDER BY vip_like_id DESC LIMIT 0,15");
