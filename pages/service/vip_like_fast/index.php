<?php
$result = mysqli_query($conn,"SELECT * FROM table_service WHERE service_slug = 'vip-like-fast-facebook'");
...
<div class="page-content">
    ...
    <div class="page-content-wrapper">
        <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="" id="service" method="POST">
                                ...
                                <input type="hidden" name="type" value="like_fast">
                                ...
                                <center>
                                    <button type="button" class="btn btn-dark btn-rounded" id="submit"
                                        onclick="vip_like_fast();"><i class="fa fa-plus-circle"></i>
            ...
            <?php require_once 'vip_like_fast_list.php'; ?>
        </div>
    </div>
</div>
<script>
function vip_like_fast() {
    ...
    $.ajax({
        url: WEBSITE_URL + prefix + 'service/vip_like_fast/',
        type: 'POST',
        dataType: 'JSON',
        data: {
            type: 'vip_like_fast',
