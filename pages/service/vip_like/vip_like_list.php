<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title p7">
                    Danh Sách <?=$row['service_title']?></h4>
                ...
                <div class="table-responsive">
                    <table class="dataTable table table-bordered table-hover text-center">
                        ...
                        <tbody>
                            <?php 
                            $result = mysqli_query($conn,"SELECT * FROM table_vip_like WHERE vip_like_username = '$user_username' AND vip_like_service = 'vip-like-avatar-facebook' ORDER BY vip_like_id DESC LIMIT 0,15");
                            ...
                            <tr>
                                ...
                                <td><?=number_format($row['vip_like_amount']);?></td>
                                <td><?=number_format($row['vip_like_amount_post']);?></td>
