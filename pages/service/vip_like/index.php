<?php
$result = mysqli_query($conn,"SELECT * FROM table_service WHERE service_slug = 'vip-like-avatar-facebook'");
...
<div class="page-content">
    ...
    <div class="page-content-wrapper">
        <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="" id="service" method="POST">
                                ...
                                <input type="hidden" name="type" value="like_viet">
                                        ...
                                        <div class="card box-static bg-main">
                                            <div class="card-body">
                                                ...
                                                <span class="text pretext"
                                                    ...
                                                    Like Việt với giá mỗi Like Việt là <span class="rate"
                                                        data-rate="0">0</span> VND / Like Việt</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <center>
                                    <button type="button" class="btn btn-dark btn-rounded" id="submit"
                                        onclick="vip_like_avatar();"><i class="fa fa-plus-circle"></i>
            ...
            <?php require_once 'vip_like_list.php'; ?>
        </div>
    </div>
</div>
<script>
function vip_like_avatar() {
    ...
    $.ajax({
        url: WEBSITE_URL + prefix + 'service/vip_like/',
        type: 'POST',
        dataType: 'JSON',
        data: {
            type: 'vip_like_avatar',
