<?php
$result = mysqli_query($conn,"SELECT * FROM table_service WHERE service_slug = 'buff-follows-facebook'");
...
<div class="page-content">
    ...
    <div class="page-content-wrapper">
        <div class="container-fluid">
                            ...
                            <form action="" id="service" method="POST">
                                        ...
                                        <div class="card box-static bg-main">
                                            <div class="card-body">
                                                ...
                                                <span class="text pretext"
                                                    ...
                                                    <span class="amount" data-amount="0">0</span> Theo
                                                    Dõi với giá mỗi Theo Dõi là <span class="rate"
                                                        data-rate="0">0</span> VND / <span class="name">Theo
                                                        Dõi</span></span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <center>
                                    <button type="button" class="btn btn-dark btn-rounded" id="submit"
                                        onclick="buff_follows();"><i class="fa fa-plus-circle"></i>
            ...
            <?php require_once 'buff_follows_list.php'; ?>
        </div>
    </div>
</div>
<script>
function buff_follows() {
    ...
    $.ajax({
        url: WEBSITE_URL + prefix + 'service/buff_follows/',
        type: 'POST',
        dataType: 'JSON',
        data: {
            type: 'buff_follows',
