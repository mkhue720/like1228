...
<div class="page-content">
    ...
    <div class="page-content-wrapper">
        <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="alert" style="background-color:#ffee77;font-weight:bold"> Lưu ý :
                                Không tăng được Share cho bài viết đang Live Stream! </div>
                            <form action="" id="service" method="POST">
                                ...
                                <div class="form-group">
                                    <label>Số lượng ( <?=$row['service_min_amount']?> ~ <?=$row['service_max_amount']?>
                                        ):</label>
                                ...
                                <center>
                                    <button type="button" class="btn btn-dark btn-rounded" id="submit"
                                        onclick="buff_share();"><i class="fa fa-plus-circle"></i>
            ...
            <?php require_once 'buff_share_list.php'; ?>
        </div>
    </div>
</div>
<script>
function buff_share() {
    ...
    $.ajax({
        url: WEBSITE_URL + prefix + 'service/buff_share/',
        type: 'POST',
        dataType: 'JSON',
        data: {
            type: 'buff_share',
