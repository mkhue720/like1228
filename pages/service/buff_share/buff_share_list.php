            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="dataTable text-center table table-bordered table-hover">
                        ...
                        <tbody>
                            <?php 
                            $result = mysqli_query($conn,"SELECT * FROM table_buff_like WHERE buff_like_username = '$user_username' AND buff_like_service = 'buff-share-facebook' ORDER BY buff_like_id DESC LIMIT 0,15");
