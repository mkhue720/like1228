...
if ($_REQUEST) {
    ...
    if ($type === 'vip_like_avatar') {
        ...
        if ($total_payment > $user_point) {
            $return['error'] = 1;
            $return['msg']   = 'Số dư tài khoản của bạn không đủ '.$total_payment.'.';
            ...
            VALUES ('$user_username', 'Mua vip like avatar người dùng.', '$total_payment', '$user_point', '$history_buy_ip', '$vip_like_time')");
